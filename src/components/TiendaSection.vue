    ...
    <div class="max-w-7xl mx-auto">
      ...
      >
        ...
        <p class="mt-4 font-inter text-lg text-brand-camel max-w-2xl mx-auto">
          Cada compra es una semilla que nos ayuda a financiar nuevos proyectos musicales, eventos de adoración y recursos para la iglesia.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <div class="relative bg-brand-gris-claro rounded-lg overflow-hidden aspect-w-1 aspect-h-1">
            <img :src="product.image1" :alt="product.name" class="w-full h-full object-cover object-center transition-opacity duration-500 ease-in-out group-hover:opacity-0">
            <img :src="product.image2" :alt="product.name" class="w-full h-full object-cover object-center absolute inset-0 opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100">
          </div>
...
const products = ref([
  ...
  },
  {
    ...
    price: '$18.00',
    image1: 'https://images.unsplash.com/photo-1529958030536-3a2cddc35361?q=80&w=1976&auto=format&fit=crop',
  ...
  },
  {
    ...
    price: '$15.00',
    image1: 'https://images.unsplash.com/photo-1608799429595-88949d3c1c1f?q=80&w=1974&auto=format&fit=crop',
