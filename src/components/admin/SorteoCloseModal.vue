    ...
    >
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 class="text-xl font-bold text-brand-negro">Cierre de sorteo</h2>
        ...
        <div class="p-8 text-center space-y-6">
          ...
          <div v-else class="space-y-4">
            ...
            <p class="text-sm uppercase tracking-widest text-gray-500">Ganador seleccionado</p>
            <h3 class="text-2xl font-playfair text-brand-negro">
              {{ winnerName || 'Por confirmar' }}
            </h3>
